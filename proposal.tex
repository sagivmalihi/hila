...
\pagebreak
\begin{figure}[h!]
\includegraphics[width=1cm]{bones.png}
\caption{A bird whose 4th digit has four phalanges.}
\label{fig:bones}
\end{figure}
\begin{figure}[h!]
\centering
\subfigure[]{\includegraphics[width=10cm]{birds2.eps} \label{fig:birdsplane}}
\subfigure[]{\includegraphics[width=10cm]{birds1.eps} \label{fig:birdstriangle}}
