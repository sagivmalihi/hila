...
\begin{figure}
\includegraphics[width=0.3in]{bones.png}
...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=2.6in]{birds2.eps} \label{fig:birdsplane}}
\subfigure[]{\includegraphics[width=2.6in]{birds1.eps} \label{fig:birdstriangle}}
